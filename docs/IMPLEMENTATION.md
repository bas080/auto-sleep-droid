...
- Bedtime is determined by capturing the timestamp when the sleep timer completes countdown without further resets during nighttime hours (8:00 PM to 6:00 AM), persisted as `last_bedtime_ms`.
