...
- **Screen-free resets & alarm controls:** Simply press a physical volume button or flip your phone over while in bed to reset the sleep timer or snooze a ringing wake-up alarm without looking at a bright screen.
...
5. **Smart wake-up alarm:** If enabled, the app automatically calculates and sets your daily wake-up alarm for your target time (or later if you went to bed late) to protect your minimum sleep duration. Flip, press a volume button, or tap **Snooze** to snooze for 9 minutes. Tap **I'm Awake** on the notification or main screen to stop the alarm and set the current wake time to that moment.
...
4. When the alarm rings or is snoozed, flip your phone over, press any physical volume button, or tap **"Snooze"** on the notification to snooze for 9 minutes. Tapping **"I'm Awake"** stops the alarm, sets your current wake-up time to that moment, and reschedules tomorrow's wake alarm to your target goal time.
