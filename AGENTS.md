...
- **Permissions Documentation:** Whenever application permissions in `AndroidManifest.xml` change, always update the "Permissions Used" section in `README.md` to document the permission and explicitly specify whether each permission is required or optional.
