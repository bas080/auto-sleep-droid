...
- **Background System Crash Analysis & Fault Tolerance:**
  When analyzing crash reports caused by background framework constraints (such as `ForegroundServiceStartNotAllowedException` or background execution limits):
